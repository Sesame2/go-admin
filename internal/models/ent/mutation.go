...
func (m *KnowledgeBaseMutation) SetDatasetID(s string) {
	m.dataset_id = &s
}

// DatasetID returns the value of the "dataset_id" field in the mutation.
func (m *KnowledgeBaseMutation) DatasetID() (r string, exists bool) {
	v := m.dataset_id
	if v == nil {
		return
	}
...
// OldDatasetID returns the old "dataset_id" field's value of the KnowledgeBase entity.
// If the KnowledgeBase object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *KnowledgeBaseMutation) OldDatasetID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *KnowledgeBaseMutation) ClearDatasetID() {
	m.dataset_id = nil
	m.clearedFields[knowledgebase.FieldDatasetID] = struct{}{}
}

// DatasetIDCleared returns if the "dataset_id" field was cleared in this mutation.
func (m *KnowledgeBaseMutation) DatasetIDCleared() bool {
	_, ok := m.clearedFields[knowledgebase.FieldDatasetID]
	return ok
}

// ResetDatasetID resets all changes to the "dataset_id" field.
func (m *KnowledgeBaseMutation) ResetDatasetID() {
	m.dataset_id = nil
	delete(m.clearedFields, knowledgebase.FieldDatasetID)
}
...
func (m *KnowledgeBaseMutation) Fields() []string {
	...
	if m.dataset_id != nil {
		fields = append(fields, knowledgebase.FieldDatasetID)
	}
	if m.created_at != nil {
...
func (m *KnowledgeBaseMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(knowledgebase.FieldDatasetID) {
		fields = append(fields, knowledgebase.FieldDatasetID)
	}
	return fields
}
